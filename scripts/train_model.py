...
from cs336_basics.trainer.utils import get_batch, get_lr_cosine_schedule, gradient_clipping
...
def parse_args():
    ...
    parser.add_argument('--wandb_run_name', type=str, default='tinystory-baseline', help='Wandb run name')
...
def main():
    ...
    for iter_num in pbar:
        ...
        # input_ids and target_ids are already tensors on device from get_batch
